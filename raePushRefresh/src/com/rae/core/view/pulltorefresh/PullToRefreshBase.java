 ...
 * the License.
 *******************************************************************************/
package com.rae.core.view.pulltorefresh;
...
import com.rae.core.view.pushtorefresh.R;
import com.rae.core.view.pulltorefresh.internal.FlipLoadingLayout;
import com.rae.core.view.pulltorefresh.internal.LoadingLayout;
import com.rae.core.view.pulltorefresh.internal.RotateLoadingLayout;
import com.rae.core.view.pulltorefresh.internal.Utils;
import com.rae.core.view.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T>
{
	...
	/**
	 * 简单的侦听器，当用户滚动到底部时发出通知。 Simple Listener that allows you to be notified when
	 * the user has scrolled to the end of the AdapterView. See (
	...
	/**
	 * 当用户执行下拉刷新或者上拉刷新时，可以添加一些额外的UI事件，如添加声音。
